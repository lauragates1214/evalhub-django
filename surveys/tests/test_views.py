...
class HomePageTest(TestCase):
    ...
    #     response = self.client.post("/", data={"survey_text": "first survey"})
    #     response = self.client.post("/", data={"survey_text": "second survey"})
    #     self.assertContains(response, "first survey")
    #     self.assertContains(response, "second survey")
